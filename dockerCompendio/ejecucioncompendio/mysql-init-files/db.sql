...
CREATE DATABASE  IF NOT EXISTS `gocrud_app` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gocrud_app`;
-- MySQL dump 10.13  Distrib 8.0.44, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: gocrud_app
-- ------------------------------------------------------
-- Server version	8.0.44
...
INSERT INTO `users` VALUES (10,'GONZ','GONZ2');
...
-- Dump completed on 2025-12-10 20:17:41
...
GRANT SELECT, INSERT, UPDATE, DELETE ON gocrud_app.* TO 'usuario'@'%';
